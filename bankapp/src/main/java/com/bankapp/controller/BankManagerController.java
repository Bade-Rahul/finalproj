...
public class BankManagerController {
	...
	@PostMapping(path="/accounts/clerk/transfer",produces=MediaType.APPLICATION_JSON_VALUE)
	...
	@PostMapping(path="/accounts/clerk/deposit",produces=MediaType.APPLICATION_JSON_VALUE,consumes=MediaType.APPLICATION_JSON_VALUE)
	...
	@PostMapping(path="/accounts/clerk/withdraw",produces=MediaType.APPLICATION_JSON_VALUE,consumes=MediaType.APPLICATION_JSON_VALUE)
	...
	@GetMapping(path="/accounts/clerk/transaction",produces=MediaType.APPLICATION_JSON_VALUE)
	public List<TransactionLog> getAlTransaction() {
		List <TransactionLog> allTrans=transService.getAllTransactionsDetails();
		return allTrans;
	}
	
	@GetMapping(path="/accounts/clerk/transaction/{id}",produces=MediaType.APPLICATION_JSON_VALUE)
